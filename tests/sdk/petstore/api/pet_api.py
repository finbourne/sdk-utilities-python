...
from tests.sdk.petstore.exceptions import (
    ApiTypeError,
    ApiValueError
)
...
class PetApi(object):
    ...
    def upload_file_with_http_info(self, pet_id, **kwargs):  # noqa: E501
        ...
        all_params = ['pet_id', 'additional_metadata', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'additional_metadata' in local_var_params:
            query_params.append(('additionalMetadata', local_var_params['additional_metadata']))  # noqa: E501
