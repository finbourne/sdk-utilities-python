...
class ApiClientFactory(ApiClientFactoryBase):
    ...
    def __init__(self, **kwargs):
        ...
        :param str api_url: Petstore API url
        ...
        :param str correlation_id: Correlation id for all calls made from the returned PetStore API instances
        """

        super().__init__(petstore, **kwargs)
